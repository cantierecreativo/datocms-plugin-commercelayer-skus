...
var _command8 = _interopRequireDefault(require("./environment/getPrimary/command"));

var _command9 = _interopRequireDefault(require("./environment/promote/command"));

var _command10 = _interopRequireDefault(require("./environment/destroy/command"));
...
module.exports = function (argv) {
  ...
  if (options['wp-import']) {
    ...
    return (0, _command3["default"])(_token5, environment, wpUrl, wpUser, wpPassword, _cmaBaseUrl5);
  }
