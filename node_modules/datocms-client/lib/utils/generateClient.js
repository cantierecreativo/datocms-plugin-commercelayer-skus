...
function generateClient(subdomain, cache) {
  ...
  return function Client(token) {
    ...
    var rawClient = new _Client["default"](token, headers, baseUrl || "https://".concat(subdomain, ".datocms.com"));
            ...
            return function call() {
              ...
              return schemaPromise.then( /*#__PURE__*/function () {
                var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(schema) {
                  var singularized, link, lastUrlId, url, body, queryString, options, deserializeResponse, deserialize, serializeRequest, _fetchRequest, _fetchRequest2, _fetchRequest3, allPages, request, fetchRequest;
                      ...
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          ...
                          deserialize = /*#__PURE__*/function () {
                            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(fetchRequest, response) {
                        ...
                        case 18:
                          ...
                          _fetchRequest = rawClient.buildPostRequest(url, body, queryString);
                        ...
                        case 21:
                          ...
                          _fetchRequest2 = rawClient.buildPutRequest(url, body, queryString);
                        ...
                        case 24:
                          ...
                          _fetchRequest3 = rawClient.buildDeleteRequest(url, queryString);
                        ...
                        case 27:
                          ...
                          request = (0, _fetchAllPages["default"])(rawClient, url, queryString);
                          return _context2.abrupt("return", request.then(function (response) {
                            return deserialize(null, response);
                          }));

                        case 31:
                          fetchRequest = rawClient.buildGetRequest(url, queryString);
